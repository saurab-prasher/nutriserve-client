                ...
                <li className='relative'>
                  {!loggedInUser ? (
                    ...
                    <div
                      ...
                      className='flex gap-2 cursor-pointer items-center mx-4'
                    >
                      <Image
                        width={56}
                        height={58}
                      ...
                      <div>
                        <div className=' z-100 '>
                          ...
                          {isHovered && (
                            <div className=' absolute top-12 -left-1 w-60 h-fit mt-2 p-5 shadow-xl rounded-md bg-white z-50  flex flex-col gap-5'>
                              ...
                              <div className='flex gap-4 hover:text-custom-green'>
                                ...
                                <Link href={"/wishlist"}>Favorite Recipes</Link>
                              </div>
                              ...
                              <div className='flex gap-4 border-t-[1px] pt-6 hover:text-custom-green'>
                                <svg
                                  xmlns='http://www.w3.org/2000/svg'
                                  fill='none'
                                  viewBox='0 0 24 24'
